      ...
      <div className="max-w-md w-full">
        <div className="bg-white rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900">LogiSync</h1>
            <p className="text-gray-600 mt-2">Logistics & Route Optimization</p>
          </div>
          ...
          <div className="mt-6 text-center space-y-3">
            <p className="text-sm text-gray-600">
              Demo accounts: admin@logisync.com / manager@logisync.com / driver@logisync.com
            </p>
